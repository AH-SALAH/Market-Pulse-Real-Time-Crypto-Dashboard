    ...
    <div className="flex flex-wrap items-center gap-3" role="search">
      ...
      <div className="relative min-w-0 flex-1 sm:max-w-xs">
        ...
        <input
          ...
          autoComplete="off"
          className="h-9 w-full rounded-lg border border-slate-800 bg-slate-900 px-3 pr-9 text-sm text-slate-200 placeholder:text-slate-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-500"
        />
        {searchQuery && (
          <button
            type="button"
            ...
            className="absolute right-1.5 top-1/2 flex h-6 w-6 -translate-y-1/2 items-center justify-center rounded text-slate-500 transition-colors hover:text-slate-200"
          >
